...
import com.example.filipe.socketcontroller.motion.MotionWearListenerService;
...
public class TargetSelectionActivity extends AppCompatActivity implements  MessageApi.MessageListener, GoogleApiClient.ConnectionCallbacks,
    ...
    private  String SELECTED_URL = "192.168.8.196/plug/%/selected/";
    private  String PLUG_URL = "192.168.8.196/plug/%";
